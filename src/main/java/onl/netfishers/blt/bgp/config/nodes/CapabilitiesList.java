...
public class CapabilitiesList implements Capabilities {
	...
	/* (non-Javadoc)
	 * @see onl.netfishers.blt.bgp.config.nodes.Capabilities#getRequiredCapabilities()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see onl.netfishers.blt.bgp.config.nodes.Capabilities#getOptionalCapabilities()
	 */
	@Override
