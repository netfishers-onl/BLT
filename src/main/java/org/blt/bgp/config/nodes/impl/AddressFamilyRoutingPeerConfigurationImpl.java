...
public class AddressFamilyRoutingPeerConfigurationImpl implements AddressFamilyRoutingPeerConfiguration {
	...
	/* (non-Javadoc)
	 * @see org.blt.bgp.config.nodes.AddressFamilyRoutingPeerConfiguration#getAddressFamilyKey()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.blt.bgp.config.nodes.AddressFamilyRoutingPeerConfiguration#getLocalDefaultPathAttributes()
	 */
	
	/* (non-Javadoc)
	 * @see org.blt.bgp.config.nodes.AddressFamilyRoutingPeerConfiguration#getLocalRoutingFilters()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.blt.bgp.config.nodes.AddressFamilyRoutingPeerConfiguration#getRemoteRoutingFilters()
	 */
	@Override
