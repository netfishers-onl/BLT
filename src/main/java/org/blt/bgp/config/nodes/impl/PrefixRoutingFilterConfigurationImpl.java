...
import org.blt.bgp.config.nodes.PrefixRoutingFilterConfiguration;
...
public class PrefixRoutingFilterConfigurationImpl extends RoutingFilterConfigurationImpl implements	PrefixRoutingFilterConfiguration {
	...
	/* (non-Javadoc)
	 * @see org.blt.bgp.config.nodes.PrefixRoutingFilterConfiguration#getFilterPrefixes()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.blt.bgp.config.nodes.impl.RoutingFilterConfigurationImpl#getType()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.blt.bgp.config.nodes.impl.RoutingFilterConfigurationImpl#subclassCompareTo(org.apache.commons.lang3.builder.CompareToBuilder, org.blt.bgp.config.nodes.RoutingFilterConfiguration)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.blt.bgp.config.nodes.impl.RoutingFilterConfigurationImpl#subclassEquals(org.apache.commons.lang3.builder.EqualsBuilder, org.blt.bgp.config.nodes.RoutingFilterConfiguration)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.blt.bgp.config.nodes.impl.RoutingFilterConfigurationImpl#subclassHashCode(org.apache.commons.lang3.builder.HashCodeBuilder)
	 */
	@Override
