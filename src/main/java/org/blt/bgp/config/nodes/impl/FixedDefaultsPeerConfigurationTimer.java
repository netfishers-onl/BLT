...
import org.blt.bgp.config.nodes.PeerConfigurationTimer;
...
public class FixedDefaultsPeerConfigurationTimer implements
	...
	/* (non-Javadoc)
	 * @see org.blt.bgp.config.nodes.PeerConfigurationTimer#getHoldTime()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.blt.bgp.config.nodes.PeerConfigurationTimer#getIdleHoldTime()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.blt.bgp.config.nodes.PeerConfigurationTimer#getDelayOpenTime()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.blt.bgp.config.nodes.PeerConfigurationTimer#getConnectRetryTime()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.blt.bgp.config.nodes.PeerConfigurationTimer#getAutomaticStartInterval()
	 */
	@Override
