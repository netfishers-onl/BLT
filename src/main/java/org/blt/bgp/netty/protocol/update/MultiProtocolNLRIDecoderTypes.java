...
public class MultiProtocolNLRIDecoderTypes {
	...
	static {
		nlriTypes.put(AddressFamilyKey.BGP_LS_TOPOLOGY, "org.blt.bgp.netty.protocol.update.bgplsnlri.BgpLsNLRICodec");
		nlriTypes.put(AddressFamilyKey.BGP_LS_VPN_TOPOLOGY, "org.blt.bgp.netty.protocol.update.bgplsnlri.BgpLsVpnNLRICodec");
	}
