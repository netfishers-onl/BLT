 ...
 * 
 * File: org.blt.bgp.netty.protocol.RouteRefreshPacket.java 
 */
...
public class RouteRefreshPacket extends BGPv4Packet {
	...
	/* (non-Javadoc)
	 * @see org.blt.bgp.netty.protocol.BGPv4Packet#encodePayload()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.blt.bgp.netty.protocol.BGPv4Packet#getType()
	 */
	@Override
	public int getType() {
